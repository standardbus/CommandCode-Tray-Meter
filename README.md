...
[![Executable size](https://img.shields.io/badge/executable-171%20KB-4c8eda)](#)
...
> — a single 171 KB file, no runtime to install — or the
...
|---|---|---|---|
| Files | `CommandCodeMonitor.exe` (171 KB) | `src/tray.ps1` + `src/session.mjs` | `bin/ccmeter` |
